...
const Icon = ({styles , name , imgUrl , isActive , disabled , handleClick}) => (
    <div className={`w-[48px] h-[48px] rounded-[20px] 
    ...
    ${!disabled && 'cursor-pointer'} ${styles}`} onClick={handleClick}>
        {!isActive ? (
            ...
            <img src = {imgUrl} alt="fund-logo" className=
...
const Slidebar = () => {
    ...
    return (
        // sidebar including logo and menu
        <div className='flex justify-between items-center flex-col sticky top-5 h-[90vh]'>
            <Link to="/">
                <Icon styles="w-[60px] h-[60px] bg-[#2c2f32]" 
                imgUrl={logo}/>
            </Link>
            {/* for sidebar background without logo */}
